...
import org.opengoofy.congomall.bff.biz.dto.req.adapter.ReceiveAddressDeleteAdapterReqDTO;
import org.opengoofy.congomall.bff.biz.dto.req.adapter.ReceiveAddressQueryAdapterReqDTO;
...
public class ReceiveAddressController {
    ...
    public ResultT<List<ReceiveAddressAdapterRespDTO>> listReceiveAddress(@RequestBody ReceiveAddressQueryAdapterReqDTO requestParam) {
        return ResultT.success(receiveAddressService.listReceiveAddressByCustomerUserId(requestParam.getUserId()));
    }
    ...
    public ResultT<Integer> updateReceiveAddress(@RequestBody ReceiveAddressUpdateAdapterReqDTO requestParam) {
        return ResultT.success(receiveAddressService.updateReceiveAddress(requestParam));
    }
    ...
    public ResultT<Integer> removeReceiveAddress(@RequestBody ReceiveAddressDeleteAdapterReqDTO requestParam) {
        return ResultT.success(receiveAddressService.removeReceiveAddress(requestParam.getUserId(), requestParam.getAddressId()));
    }
}
